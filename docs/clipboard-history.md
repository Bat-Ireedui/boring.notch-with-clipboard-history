...
Clipboard history for boring.notch: a Clipboard tab inside the notch that keeps what you copy.
...
| `boringNotch/components/Settings/Views/ClipboardSettingsView.swift` | Settings page |
...
| `boringNotch/components/Settings/SettingsView.swift`, `Views/ShortcutsSettingsView.swift` | Sidebar entry and shortcut recorder |
